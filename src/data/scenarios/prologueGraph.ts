...
export const prologueGraph: PuzzleGraph = {
  ...
  strings: {
    zh: {
      ...
      'letter.title': '一封旧信',
      'letter.body': '信里提到「把东西存在 D 盘备份里」，还改了 QQ 签名。去 D 盘的「游戏」文件夹翻翻那段聊天记录。',
    ...
    en: {
      ...
      'intro.body': 'The desktop "Memo" note might help; a few undeleted old letters still sit in the Recycle Bin.',
      'letter.title': 'An old letter',
      'letter.body': 'It mentions "I backed everything up on the D: drive" and a changed QQ status. Dig up that chat log in D:\\Games.',
