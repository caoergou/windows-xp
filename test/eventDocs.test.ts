 ...
 * reference table in USAGE.md is generated from it by scripts/gen-events-doc.mjs.
...
describe('event reference docs', () => {
  it('USAGE.md event table is in sync with src/events.ts (run `npm run docs:events`)', () => {
    let ok = true;
    let output = '';
    try {
