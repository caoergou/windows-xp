...
test.describe('Decryption System', () => {
  ...
  test('QZone: Encrypted Album requires password', async ({ page }) => {
    ...
    // Based on QQ.jsx code, it has a login screen initially.
    // "Initialize from JSON data" -> if qqData.login.remember is true, it fills.

    // Wait for QQ window
    // We can look for the login button if present.
    ...
    // We can look for "[空间]" text which is in the UserHeader.
