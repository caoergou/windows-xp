[@caoergou/windows-xp](/windows-xp/docs/zh/api/index.md) / [index](/windows-xp/docs/zh/api/index/index.md) / FolderNode
...
&gt; **children**: `Record`\&lt;`string`, [`FileNode`](/windows-xp/docs/zh/api/index/type-aliases/FileNode.md)\&gt;
