...
Every shortcut — whether global or app-specific — is listed in one central keymap. `Mod` is the platform primary modifier — **Ctrl** on Windows/Linux,
...
**Browser reserved keys.** The browser reserves some keys (`Ctrl+W`/`T`/`N`,
