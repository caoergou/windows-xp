...
import { runStudioPackCommand } from './studioExport';
import {
  completeRepl,
  formatDebugState,
...
export const startScenarioServer = async (
  ...
  const executeAuthoringCommand = async (command: AuthoringCommand): Promise<unknown> => {
    ...
    if (command.type === 'pack-estimate' || command.type === 'pack-export') {
      return runStudioPackCommand(currentInput, snapshot, command);
    }
...
.asset-filters{display:flex;gap:4px;margin:8px 0}.asset-filters button[aria-pressed=true]{border-color:var(--accent);color:var(--accent);background:rgb(239 246 255)}.asset>span small{display:block;color:rgb(185 28 28)}
.export-card{display:grid;gap:12px;margin:18px 0;padding:14px;border:1px solid var(--line);border-radius:8px;background:var(--surface-raised)}.export-title,.export-actions,.receipt-heading,.export-path{display:flex;align-items:center;justify-content:space-between;gap:10px}.export-title h3{margin:2px 0 0}.export-title>div>span,.receipt-heading>span,.export-path>span,.export-chunks>span{font-size:10px;font-weight:700;letter-spacing:.07em;text-transform:uppercase;color:var(--muted)}.signature-state{padding:3px 7px;border-radius:999px;color:rgb(146 64 14);background:rgb(254 243 199);font-size:10px;font-weight:700}.export-controls{display:grid;grid-template-columns:1fr 1fr;gap:8px}.export-controls label{margin:0}.export-actions{justify-content:flex-end}.export-actions button:disabled,.export-controls select:disabled{cursor:not-allowed;opacity:.55}.export-receipt{display:grid;gap:10px;padding:12px;border:1px solid rgb(191 219 254);border-radius:7px;background:rgb(239 246 255)}.export-receipt dl{display:grid;grid-template-columns:repeat(4,1fr);gap:6px;margin:0}.export-receipt dl>div{display:grid;gap:2px}.export-receipt dt{font-size:10px;text-transform:uppercase;color:var(--muted)}.export-receipt dd{margin:0;font-weight:700}.export-receipt .unsigned{color:rgb(146 64 14)}.export-chunks{display:grid;gap:5px}.export-chunks>div{display:grid;grid-template-columns:minmax(80px,1fr) auto auto;gap:7px;padding-top:5px;border-top:1px solid rgb(191 219 254);font-size:11px}.export-chunks>div span{color:var(--muted)}.export-path{align-items:flex-start;flex-wrap:wrap}.export-path code{min-width:0;overflow-wrap:anywhere}.security-boundary{display:grid;gap:5px;padding-left:10px;border-left:3px solid rgb(217 119 6)}.security-boundary span,.deployment-guide p{font-size:11px;line-height:1.45;color:var(--muted)}.deployment-guide{margin:0}.deployment-guide p{margin:7px 0}.export-error{margin:0;color:rgb(185 28 28);font-size:12px}@media(max-width:520px){.export-controls,.export-receipt dl{grid-template-columns:1fr}.export-title{align-items:flex-start}.export-chunks>div{grid-template-columns:1fr auto}}
</style></head>
